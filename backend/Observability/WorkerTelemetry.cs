...
/// <summary>
/// Telemetry configuration specific to the CopilotEval worker processes (JobProcessor)
/// </summary>
public static class WorkerTelemetry
{
    ...
    /// </summary>
    public static Activity? StartActivityWithCorrelation(string activityName, IReadOnlyDictionary<string, object> messageProperties)
    {
